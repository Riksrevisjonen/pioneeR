...
- Added new function `summary_tbl_dea` to create a summary table of efficiency scores from a vector of efficiency scores or an object of type Farrell as returned from the `Benchmarking::dea` function
